      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-xl text-gray-600">
            Manage all registered recruiters
          </p>
        </div>
        ...
        {!loading && !error && (
          <div className="space-y-6">
            {recruiters.map((recruiter) => (
              <div key={recruiter._id} className="bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-6 py-4 border-b border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div className="mb-4 sm:mb-0">
                      <h3 className="text-lg leading-6 font-medium text-gray-900">{recruiter.name}</h3>
                      <p className="mt-1 text-sm text-indigo-600">{recruiter.company}</p>
                ...
                {expandedRecruiters[recruiter._id] && (
                  <div className="px-6 py-4 bg-gray-50">
                    <h4 className="text-lg font-medium text-gray-900 mb-4">Job Listings</h4>
                    <div className="space-y-4">
                      {recruiter.jobs.map((job) => (
                        <div key={job._id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Edit Recruiter</h3>
